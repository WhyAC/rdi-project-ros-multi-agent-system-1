...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "move_fix");
    ros::NodeHandle n;
    ros::Subscriber sub_odometry = n.subscribe("/agent1/odom", 10, odomCallbackLeader);
    ros::Publisher movement_pub = n.advertise<geometry_msgs::Twist>("/agent1/cmd_vel",10); 
    ros::Publisher input_publeader = n.advertise<minilab_navigation::Input>("/agent1/input",10);      
