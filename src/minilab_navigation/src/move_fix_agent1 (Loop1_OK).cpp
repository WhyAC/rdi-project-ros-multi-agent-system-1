...
int main(int argc, char **argv)
{
    ...
    t_last = ros::Time::now();
    while(ros::ok() && ((t_last.toSec()) <= (time_sw+100.0)) )
    {
		...
		// calculate e1
		e_1 = px_agent1 - px_leader; // x_2 - x_2d; // position d'agent1 - position du leader
				
		// calculate e2
		e_2 = vx_agent1 - vx_leader; //vxa - vxl; // vitesse d'agent1 - vitesse du leader
	...
	while (ros::ok() && ((t_last.toSec()) > (time_sw+100.0)) )
	{
		...
		// calculate e1
		//e_1 = x_2 - x_2d; // x_2 position de agent1, x_2d position de leader
		// e_1 = e_1dot; e_1 += e_1dot * delta_t.toSec();
		// calculate e2
		//e_2 = u_1 + d_1 - u_1d; // u_1 vitesse de agent1, x_2d vitesse de leader
		// e_2 = e_2dot; e_2 += e_2dot * delta_t.toSec();
